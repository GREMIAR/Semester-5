...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 05 2021 г., 03:42
...
CREATE TABLE `head` (
  ...
  `Параметры_страницы` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `head` (`Head_ID`, `Параметры_страницы`) VALUES
...
CREATE TABLE `пункт_навигации` (
  ...
  `Название` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `пункт_навигации` (`Пункт_навигации_ID`, `Название`) VALUES
