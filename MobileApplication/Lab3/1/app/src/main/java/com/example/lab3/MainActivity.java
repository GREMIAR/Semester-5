...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickThirdButton(View view)
    {
        ...
        values.put(OurContractTest.FeedEntry.LastName, "Иванов");
        values.put(OurContractTest.FeedEntry.FirstName, "Иван");
        values.put(OurContractTest.FeedEntry.Patronymic, "Иванович");
