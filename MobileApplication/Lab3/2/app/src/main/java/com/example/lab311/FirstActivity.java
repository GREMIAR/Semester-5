...
public class FirstActivity extends AppCompatActivity {
    ...
    public static void InsertInto(String name, String dateRecording,SQLiteDatabase db)
    {
        ContentValues values = new ContentValues();
        values.put(OurContractTest.FeedEntry.Name, name);
